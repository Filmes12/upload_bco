...
const auth = new google.auth.GoogleAuth({
  keyFile: 'subir-arquivos-deb0696c2458.json', // Substitua pelo seu arquivo de credenciais
...
app.post('/upload', async (req, res) => {
  ...
  upload(req, res, async function (err) {
    ...
    try {
      const folderId = req.body.folder || defaultFolderId; // Se não for especificada uma pasta, usa a padrão
